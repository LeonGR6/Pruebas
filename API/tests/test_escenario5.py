...
#En este escenario, un usuario desea pedir un libro prestado; por lo que deberá de registrarse, -
#loguearse y luego completar el registro para el prestamo, posteriormente el encargado de prestamos -
#verificará dicho registro y otorgará el libro deseado por el usuario.
...
#   Aqui el encargado de prestamos verifica el registro de prestamos verificando que se encuentre el usuario
#  y el libro, otorgando así el libro.
...
# usuario intente acceder a una parte de la plataforma que no existe
